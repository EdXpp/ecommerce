...
class User extends Model {
	...
	public static function OLD_getForgot($email)
	{
		...
		else
		{
			...
			else
			{
				...
				*/
				...
				$mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir Senha da Montserrat Casa", "forgot", array(
					"name"=>$data["desperson"],
					"link"=>$link
				));
	...
	public static function getForgot($email, $inadmin = true)
	{
		...
		else
	    {
	        ...
	        else
		    {
	            ...
	            $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha de Montserrat Casa", "forgot", array(
	                 "name"=>$data['desperson'],
	                 "link"=>$link
	            )); 
     /*
			var_dump("=============INICIO USER PHP ================================================");
			var_dump($mailer);

			var_dump("=========FIM USER PHP =======================================");
			exit;
	*/
